/*===========================================================================*\
  ...
  Copyright © 2012-2013, 2015-2021 Andy Foy Consulting
 ...
 *****************  Version 19  ****************
 ...
 A. Enable partner geometry to be null or zero area.

 *****************  Version 18  ****************
 Author: Andy Foy		Date: 09/10/2020
 A. Replace hard-coded PartnerName column with parameter.
...
\*===========================================================================*/
	...
	BEGIN
		...
		If @debug = 1
		BEGIN
			IF @PartnerGeom IS NULL OR @PartnerGeom.STArea() = 0
		...
		BEGIN
			...
			IF @PartnerGeom IS NOT NULL AND @PartnerGeom.STArea() <> 0
			BEGIN
