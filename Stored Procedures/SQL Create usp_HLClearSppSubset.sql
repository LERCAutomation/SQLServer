/*===========================================================================*\
  ...
  HLClearSppSubset is free software: you can redistribute it and/or modify
  it under the terms of the GNU General Public License as published by
  the Free Software Foundation, either version 3 of the License, or
  (at your option) any later version.
  
  HLClearSppSubset is distributed in the hope that it will be useful,
...
if exists (select ROUTINE_NAME from INFORMATION_SCHEMA.ROUTINES where ROUTINE_SCHEMA = 'dbo' and ROUTINE_NAME = 'HLClearSppSubset')
	DROP PROCEDURE dbo.HLClearSppSubset
GO

-- Create the stored procedure
CREATE PROCEDURE [dbo].[HLClearSppSubset] @Schema varchar(50),
