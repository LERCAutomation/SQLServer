...
If EXISTS (SELECT ROUTINE_NAME FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'dbo' AND ROUTINE_NAME = 'AFSelectSppRecords2')
	DROP PROCEDURE dbo.AFSelectSppRecords2
GO

-- Create the stored procedure
CREATE PROCEDURE dbo.AFSelectSppRecords2
	@Schema varchar(50),
