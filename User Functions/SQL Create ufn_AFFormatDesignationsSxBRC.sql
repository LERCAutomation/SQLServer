...
if exists (select ROUTINE_NAME from INFORMATION_SCHEMA.ROUTINES where ROUTINE_SCHEMA = 'dbo' and ROUTINE_NAME = 'AFFormatDesignationsSxBRC')
	DROP FUNCTION dbo.AFFormatDesignationsSxBRC
GO

-- Create the user function
CREATE FUNCTION [dbo].[AFFormatDesignationsSxBRC]
(
	@TextIn varchar(200)
)
RETURNS varchar(200)
