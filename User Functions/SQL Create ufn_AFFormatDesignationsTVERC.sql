...
if exists (select ROUTINE_NAME from INFORMATION_SCHEMA.ROUTINES where ROUTINE_SCHEMA = 'dbo' and ROUTINE_NAME = 'AFFormatDesignationsTVERC')
	DROP FUNCTION dbo.AFFormatDesignationsTVERC
GO

-- Create the user function
CREATE FUNCTION [dbo].[AFFormatDesignationsTVERC]
(
	@TextIn varchar(200)
)
RETURNS varchar(200)
