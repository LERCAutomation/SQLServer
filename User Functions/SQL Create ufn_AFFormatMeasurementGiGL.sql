...
/*===========================================================================*\
  Description:	
		...
		way particular to GiGL's requirements.
...
if exists (select ROUTINE_NAME from INFORMATION_SCHEMA.ROUTINES where ROUTINE_SCHEMA = 'dbo' and ROUTINE_NAME = 'AFFormatMeasurementGiGL')
	DROP FUNCTION dbo.AFFormatMeasurementGiGL
GO

-- Create the user function
CREATE FUNCTION [dbo].[AFFormatMeasurementGiGL]
(
	@MUnit varchar(40),
	@MQual varchar(40),
	@MData varchar(20)
