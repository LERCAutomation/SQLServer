...
/*===========================================================================*\
  Description:	
		...
		way particular to DERC's requirements.
...
if exists (select ROUTINE_NAME from INFORMATION_SCHEMA.ROUTINES where ROUTINE_SCHEMA = 'dbo' and ROUTINE_NAME = 'AFFormatMeasurementDERC')
	DROP FUNCTION dbo.AFFormatMeasurementDERC
GO

-- Create the user function
CREATE FUNCTION [dbo].[AFFormatMeasurementDERC]
(
	@MUnit varchar(40),
	@MQual varchar(40),
	@MData varchar(20)
