...
/*===========================================================================*\
  Description:	
		...
		Status Abbreviations used by TVERC for a particular
		Taxon_List_Item_Key.
...
if exists (select ROUTINE_NAME from INFORMATION_SCHEMA.ROUTINES where ROUTINE_SCHEMA = 'dbo' and ROUTINE_NAME = 'AFGetDesignationsTVERC')
	DROP FUNCTION dbo.AFGetDesignationsTVERC
GO

-- Create the user function
CREATE FUNCTION [dbo].[AFGetDesignationsTVERC]
(
