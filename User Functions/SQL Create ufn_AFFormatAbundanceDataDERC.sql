...
/*===========================================================================*\
  Description:	
		...
		Needs additional UDF 'AFFormatMeasurementDERC' to do calculations
...
if exists (select ROUTINE_NAME from INFORMATION_SCHEMA.ROUTINES where ROUTINE_SCHEMA = 'dbo' and ROUTINE_NAME = 'AFFormatAbundanceDataDERC')
	DROP FUNCTION dbo.AFFormatAbundanceDataDERC
GO

-- Create the user function
CREATE FUNCTION [dbo].[AFFormatAbundanceDataDERC]
(
	@TOCCKey char(16)
)
